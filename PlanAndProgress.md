...
- [x] 高饱和大回血（CD长）：肉汤 - 烹饪锅 回复 7 颗心
- [x] 低饱和小回血（主要血药）：混合沙拉 - 农夫乐事 回复 3 颗心，缓慢回复 1 颗心
- [ ] 低饱和小 Buff（主要 Buff 药）：
- [ ] 高饱和大 Buff（CD长）：
- [ ] 技能食物（Spellbind）：
...
- 果酱蜜饯（3鸡腿低饱和无buff水果）
- 莎莎酱（3.5鸡腿高饱和急迫buff洋葱番茄素食【重点备选】）
- 西瓜冰（2.5鸡腿低饱和速度跳跃提升西瓜木棍冰）
- 水果拼盘（4鸡腿高饱和速度水果）
- 
...
属性：生命值 120，受到大于 10 的伤害会被限制到 10，其余不变。

技能：

1. 每次被玩家攻击时，有概率召唤 X 个血量较低的分身（X 介于 1-4，从 1-4 触发概率之比为4：3：2：1，分身的血量之和为 48），然后使自己隐身 (10X-5) 秒钟。
...
送别：你终于还是突破了第一道封印。不要太得意了，前面还有更强大的守卫者在等待你呢。
