...
- [*] 禁止 Dannys Expansion 的生物在第一阶段的世界生成。（现已完全不会生成，无需再写 ZC 脚本。）
- [*] 增加琥珀与岩化根的实际用途。
...
- [*] DruidCraft 镰刀的新功能：破坏草和作物时，将附近的草掉落物和作物掉落物 ~~拉到使用者身边~~ 吸入使用者的背包。
- [*] 马鞍和皮革马铠均可用皮革或布头、棕色地毯（可可豆），以及锁链合成。
- [*] 布头可以代替皮革合成皮革盔甲。尽管这样做可以让布头通过农夫乐事的砧板转化为皮革，但考虑到皮革的实际价值与布头差不多，这种转化可以允许。
- [*] 锁链可以与布头/皮革一起合成锁链甲。
- [*] 修改 DruidCraft 的生长灯配方。

### 第一阶段

- [*] ~~删除主世界中原版红石、青金石、钻石的生成、DruidCraft 月光石、碧海新生包含鹦鹉螺的石头的生成，~~ 重新构造一个只生成煤、铁、~~金、~~（第一阶段用不到，故删除）琥珀、岩化根、烈焰玻璃、岩盐、碳酸钠的世界。目前的方案为，煤矿脉中，煤、烈焰玻璃、铁以7:2:1比例伴生；铁矿脉中，铁、煤以7:3比例伴生；化石矿脉中，岩化根、琥珀、骨块以3:3:1比例伴生。~~盐矿脉中，岩盐、碳酸钠以1:1比例伴生~~（**整个 VFP 中盐和干燥食物的内容移动到狩猎世界，与食物腐败机制关联**）
- [*] 检查 ~~农夫乐事的野菜、~~ （已确认会生成）~~简单茶树的茶树是否生成。~~ 不会生成。**将茶相关内容移动到二阶段**。
- [*] 允许玩家制作便携工作台。
- [*] 岩化根和琥珀可以制作和修复矿物探测器和金属探测器和群系指南针。
- [ ] 探测器和群系指南针应有说明文字。
- [*] ~~给草方块和草添加掉落物“苔藓团”。~~ 已添加。该物品直接右键使用，0.1 概率恢复 4 心，0.3 概率恢复 2 心，期望为恢复 1 心。
- [*] ~~苔藓团可以与（某物品）合成“简易创可贴”，~~ 已添加。该物品直接右键使用，0.3 概率恢复 3 心，0.6 概率恢复 1 心，期望为恢复 1.5 心。
- [*] ~~确定上一条中的“某物品”~~ 确定为 DruidCraft 的线麻合成的物品“布头”。
...
- [*] 在进入此阶段之前盐和碳酸钠不能获得，因此将所有需要盐和碳酸钠合成的物品都加上 tooltip 以示提醒。
